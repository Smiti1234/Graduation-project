...
Процедура ДекорацияНастройкиПодключенияКурьерикаНажатие(Элемент)
	...
	ПараметрыФормы.Вставить("ТипГрузоперевозки", СервисДоставкиКлиентСервер.ТипГрузоперевозкиСервис1СКурьерика());
	ПараметрыФормы.Вставить("ОрганизацияБизнесСети", СервисДоставкиВызовСервера.ОрганизацияПоУмолчанию(ПараметрыФормы.ТипГрузоперевозки));
