...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Строка Из ШтрихкодыУпаковок Цикл
		Строка.ТипУпаковки = Строка.ШтрихкодУпаковки.ТипУпаковки;
	КонецЦикла;
...
Процедура ОбновитьИтоги()
	...
	Элементы.ДекорацияМаркированныйТовар.Заголовок = НСтр("ru = 'Маркированный товар: '") + Марк;
	Элементы.ДекорацияМонотоварнаяУпаковка.Заголовок = НСтр("ru = 'Монотоварная упаковка: '") + Моно;
	Элементы.ДекорацияМультитоварнаяУпаковка.Заголовок = НСтр("ru = 'Мультитоварная упаковка: '") + Мульти;
