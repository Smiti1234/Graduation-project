...
Процедура ПриОткрытии(Отказ)
	...
	Если Элементы.УчетнаяЗаписьМаркетплейса.СписокВыбора.Количество() = 0 Тогда
...
Процедура ОбновитьСписокУчетныхЗаписей(УчетнаяЗаписьПоУмолчанию = Неопределено)
	...
	Элементы.УчетнаяЗаписьМаркетплейса.СписокВыбора.Очистить();
	...
	Если СписокНастроекПодключенияКСервису.Количество() > 0 Тогда
		...
		Для Каждого НастройкаПодключения Из СписокНастроекПодключенияКСервису Цикл
			Элементы.УчетнаяЗаписьМаркетплейса.СписокВыбора.Добавить(НастройкаПодключения.Значение,
		...
		Если Не ЗначениеЗаполнено(УчетнаяЗаписьПоУмолчанию)
			...
			УчетнаяЗаписьМаркетплейса = СписокНастроекПодключенияКСервису[0].Значение;
		КонецЕсли;
