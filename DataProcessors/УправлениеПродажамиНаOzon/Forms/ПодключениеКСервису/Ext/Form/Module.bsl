...
Процедура Подключить(Команда)
	...
	ДанныеУчетнойЗаписи.Организация = УчетнаяЗаписьМаркетплейса.Организация;
	ДанныеУчетнойЗаписи.ИдентификаторКлиента = УчетнаяЗаписьМаркетплейса.ИдентификаторКлиента;
