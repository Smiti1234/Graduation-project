...
&НаСервере
Процедура ИнформацияОДоступныхОбновленияхИзФайлаНаСервере(ВерсииРегламентированныхОтчетов)
...
&НаСервере
Функция ИнтерактивноеОбновлениеРегламентированныхОтчетовИзФайла(АдресФайла)
