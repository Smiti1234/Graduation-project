...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры.ПараметрыДокумента);
...
Функция ПараметрыОтправкиЭлектронногоПисьма()
	...
	ИнтеграцияShareКлиентПереопределяемый.ЗаполнитьПараметрыОтправкиЭлектронногоПисьма(ПараметрыОтправки,
		ПараметрыДокумента, ЗаполнитьПоУмолчанию);

	Если ЗаполнитьПоУмолчанию = Ложь Тогда
