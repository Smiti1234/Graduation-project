	...
	Иначе
		...
		Если ТипЗнч(Настройки) = Тип("Структура") Тогда
			...
			Если Настройки.Свойство("ОтборТипыДокументов") Тогда
				...
				СохраненныеОтборТипыДокументов = Настройки.ОтборТипыДокументов.ВыгрузитьЗначения();
				Для Каждого ТипДокумента Из СохраненныеОтборТипыДокументов Цикл
					Если ТипЗнч(ТипДокумента) = Тип("Тип") 
						И Метаданные.ОпределяемыеТипы.ДокументыЭПД.Тип.СодержитТип(ТипДокумента) Тогда
						ОтборТипыДокументов.Добавить(ТипДокумента);
					КонецЕсли;
				КонецЦикла;
			КонецЕсли;
