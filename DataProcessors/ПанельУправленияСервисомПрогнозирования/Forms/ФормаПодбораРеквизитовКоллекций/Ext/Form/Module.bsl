		...
		Иначе
			...
			Для Каждого УровеньРеквизитов Из ВерхнийУровень.ПолучитьЭлементы() Цикл
				...
				Если КоллекцияВыгружалась
					...
					ИнфоКоллекции = РегистрыСведений.КоллекцииСервисаПрогнозированияПродаж.ПолучитьИнформациюКоллекции(ИмяВИсточнике);
					ИнфоКоллекции.ИзмененФормат = Истина;
					РегистрыСведений.КоллекцииСервисаПрогнозированияПродаж.ЗаписатьИнформациюКоллекции(ИмяВИсточнике, ИнфоКоллекции);
				КонецЕсли;
