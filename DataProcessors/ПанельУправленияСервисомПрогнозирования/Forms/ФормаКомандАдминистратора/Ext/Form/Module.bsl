...
Функция СписокКоллекций()
	...
	Массив.Добавить(Перечисления.КоллекцииСервисаПрогнозированияПродаж.Категории);
	...
	Массив.Добавить(Перечисления.КоллекцииСервисаПрогнозированияПродаж.Заказы);
	Массив.Добавить(Перечисления.КоллекцииСервисаПрогнозированияПродаж.Промо);
	Массив.Добавить(Перечисления.КоллекцииСервисаПрогнозированияПродаж.ПланыПродаж);
	Массив.Добавить(Перечисления.КоллекцииСервисаПрогнозированияПродаж.Сезонность);
	Массив.Добавить(Перечисления.КоллекцииСервисаПрогнозированияПродаж.Календарь);
...
Процедура ВидПланаПриИзмененииНаСервере()
	...
	ПрогнозПоКатегориям = ТипПлана = Перечисления.ТипыПланов.ПланПродажПоКатегориям;
...
Процедура ОбновитьИсториюОбученияНаСервереФинальный()
	...
	Для Каждого ОбъектИстории Из СтруктураОтвета.ДесериализованноеЗначение Цикл
		...
		ИдентификаторОбъектаПрогноза = ОбъектИстории["product_id"];
		Если СервисПрогнозирования.ЭтоПустойИдентификатор(ИдентификаторОбъектаПрогноза) Тогда
			НоваяСтрока.Объект = "";
			Продолжить;
		КонецЕсли;
