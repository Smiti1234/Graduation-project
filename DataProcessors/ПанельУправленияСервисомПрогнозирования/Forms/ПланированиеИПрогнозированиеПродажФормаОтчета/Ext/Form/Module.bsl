...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыполненоПодключение = ВыполненоПодключение();
...
Процедура ПриИзмененииДоступностиОсновногоСервера(СтандартнаяОбработка)
	...
	Возврат; // Сервис прогнозирования.
...
Процедура УстановитьВидимостьДоступность()
	...
	Иначе
		Элементы.СтатусОбучения.Видимость = Истина;
...
Процедура ОбновитьПрогнозНаСервере()
	...
	Если ЗначениеЗаполнено(ВидПлана) Тогда
		...
		НоваяСтрока.Объект = СценарийПрогнозирования;
