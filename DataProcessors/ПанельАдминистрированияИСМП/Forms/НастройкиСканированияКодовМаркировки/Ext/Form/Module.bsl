...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьПредупреждениеРедактированияИспользованияПроверкиРозничнымМетодом(ЭтотОбъект);
...
&НаКлиенте
Процедура ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГруппПриИзменении(Элемент)
	
	Подключаемый_ПриИзмененииРеквизита(Элемент);
	ПриИзмененииРежимаИспользоватьПроверкуРозничнымМетодом();
...
&НаКлиенте
Процедура ПриИзмененииРежимаИспользоватьПроверкуРозничнымМетодом()
	
	УстановитьПредупреждениеРедактированияИспользованияПроверкиРозничнымМетодом(ЭтотОбъект);
	
	Если ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп Тогда
		
		ВключитьНастройкиДляПроверкиРозничнымМетодом();
...
&НаСервере
Процедура ВключитьНастройкиДляПроверкиРозничнымМетодом()
	
	Обработки.ПанельАдминистрированияИСМП.ВключитьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп();
...
Процедура УстановитьПредупреждениеРедактированияИспользованияПроверкиРозничнымМетодом(Форма)
	
	Если Форма.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп Тогда
		
		Форма.Элементы.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп.ПредупреждениеПриРедактировании
			= НСтр("ru = 'Внимание! Отключение этого режима не рекомендуется'");
		
	Иначе
		
		Форма.Элементы.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп.ПредупреждениеПриРедактировании
			= НСтр("ru = 'Внимание! Включение этого режима приведет к включению запросов к ГИС МТ, если ранее они не были включены'");
...
Процедура УстановитьВидимостьДоступностьОтПроверкиРозничнымМетодом()
	...
	Элементы.ЗапрашиватьДанныеСервисаИСМП.ТолькоПросмотр            = ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп;
	Элементы.КонтролироватьВладельцевКодовМаркировки.ТолькоПросмотр = ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп;
	Элементы.КонтролироватьСтатусыКодовМаркировки.ТолькоПросмотр    = ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп;
	...
	Элементы.ГруппаОписаниеСеройЗоны.Видимость                      = ВедетсяУчетТГТребующихОбязательногоКонтроля 
		И ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп
	...
	Если ВедетсяУчетТГТребующихОбязательногоКонтроля Тогда
		...
		ШаблонТекстаКомментария =
			НСтр("ru = 'Согласно ФЗ № 381-ФЗ ""Об основах торговой деятельности в Российской Федерации"" по товарным группам %1 планируется ввести обязательную проверку кодов маркировки через сервис.
		...
		Элементы.КомментарийОЗапретеИзмененияНастройки.Заголовок = ТекстКомментария;
