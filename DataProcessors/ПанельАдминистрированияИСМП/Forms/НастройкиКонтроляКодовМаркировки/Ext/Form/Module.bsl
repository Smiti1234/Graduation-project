...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбязательныеТГДляПроверкиПриРозничнойПродаже.ЗагрузитьЗначения(ИнтеграцияИСМПКлиентСерверПовтИсп.ВидыПродукцийОбязательнойОнлайнПроверкиПередРозничнойПродажей());
...
Процедура ТаблицаНастроекПредставлениеЗначенияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПоказыватьПодсказкуОграниченияИсключений = ТекущиеНастройкиСканирования.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп
	...
	Если ВариантОтображения = ВариантПоВидамПродукции() Тогда
		...
		Для Каждого ЭлементВидОперации Из ДопустимыеВидыОпераций Цикл
			...
			Если ТекущиеНастройкиСканирования.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп
...
Процедура ЗаполнитьСписокВыбораЗначения()
	...
	ПредставлениеПустогоЗначения = ПредставлениеВсеЗначения(ВариантОтображения,
		ТекущиеНастройкиСканирования.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп
		И (ТекущиеДанные.Настройка = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВыводИзОборотаРозничнаяПродажа")
			Или ОбязательныеТГДляПроверкиПриРозничнойПродаже.НайтиПоЗначению(ТекущиеДанные.Настройка) <> Неопределено));
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", ПредставлениеВсеЗначения(Вариант, ТекущиеНастройкиСканирования.ИспользоватьПроверкуРозничнымМетодомДляОпределенныхТоварныхГрупп));
