...
Процедура ЗагрузитьОборотыОФД(Команда)
	...
	Если НЕ ТекущиеДанные = Неопределено Тогда
		...
		МенеджерОфлайнОборудованияКлиент.НачатьЗагрузкуОборотовИзОФД(ТекущиеДанные.Ссылка, УникальныйИдентификатор, Неопределено, 0);
...
Процедура ЗагрузитьЧекиОФД(Команда)
	...
	Если НЕ ТекущиеДанные = Неопределено Тогда
		...
		МенеджерОфлайнОборудованияКлиент.НачатьЗагрузкуЧековИзОФД(ТекущиеДанные.Ссылка, УникальныйИдентификатор, Неопределено, 0);
