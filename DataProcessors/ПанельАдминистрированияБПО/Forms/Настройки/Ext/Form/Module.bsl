...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если МенеджерОборудованияВызовСервера.ИспользуетсяЧекопечатающиеУстройства() Тогда
		...
		СрокХраненияФискальныхОпераций = МодульОборудованиеЧекопечатающиеУстройстваВызовСервера.ПериодХраненияИсторииФискальныхОпераций();
		СрокХраненияОперацийОчередиЧеков = МодульОборудованиеЧекопечатающиеУстройстваВызовСервера.ПериодХраненияИсторииОперацийОчередиЧеков();
		Если Не ЗначениеЗаполнено(СрокХраненияФискальныхОпераций) Тогда
			...
			СохранитьЗначениеРеквизита("СрокХраненияФискальныхОпераций");
		КонецЕсли;
		Если Не ЗначениеЗаполнено(СрокХраненияОперацийОчередиЧеков) Тогда
			...
			СохранитьЗначениеРеквизита("СрокХраненияОперацийОчередиЧеков");
		КонецЕсли;
	КонецЕсли;
	Если МенеджерОборудованияВызовСервера.ИспользуетсяПлатежныеСистемы() Тогда
		...
		СрокХраненияПлатежныхОпераций = МодульОборудованиеПлатежныеСистемыВызовСервера.ПериодХраненияИсторииПлатежныхОпераций();
		Если Не ЗначениеЗаполнено(СрокХраненияПлатежныхОпераций) Тогда
			...
			СохранитьЗначениеРеквизита("СрокХраненияПлатежныхОпераций");
		КонецЕсли;
	КонецЕсли;
