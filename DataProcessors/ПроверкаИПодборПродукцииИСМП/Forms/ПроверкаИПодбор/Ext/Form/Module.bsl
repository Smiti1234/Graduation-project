...
Функция НеобходимоОбращениеКСервисуИСМП(ПараметрыСканирования, ПараметрыПроверкиКодовМаркировки)
	...
	Если Не ПараметрыСканирования.ЗапрашиватьДанныеСервисаИСМП
...
Функция ТребуетсяВопросПередЗавершениемПроверки(ПропуститьПроверкуКоличества = Ложь)
	...
	Если РежимПодбораСуществующихУпаковок И Не ПропуститьПроверкуКоличества Тогда
...
&НаСервереБезКонтекста
Функция ЗапроситьСокращеннуюИнформациюПоКодамМаркировки(СоответствиеШтрихкодовСтрокДерева, ВидПродукции, Организация)
	...
	РезультатЗапроса = ИнтерфейсИСМП.СокращеннаяИнформацияПоКМПриРозничнойПродаже(ТаблицаМаркировки, Организация);
	...
	ВозвращаемоеЗначение.Вставить("ТребуетсяОбновлениеКлючаСессии", РезультатЗапроса.ТребуетсяОбновлениеКлючаСессии);
	ВозвращаемоеЗначение.Вставить("СтатусыКодовМаркировки",         СтатусыКодовМаркировки);
	ВозвращаемоеЗначение.Вставить("РазрешенаПродажа",               РезультатЗапроса.РазрешенаПродажа);
	ВозвращаемоеЗначение.Вставить("ТекстОшибки",                    РезультатЗапроса.ТекстОшибки);
