...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не (ЗначениеЗаполнено(Объект.Контрагент) Или ИспользоватьНесколькоОрганизаций) Тогда
...
Процедура РазъединитьСтрокуИтоговыеЗаписи(Команда)
	...
	СтрокаКонтрагента = Объект.ИтоговыеЗаписи.Вставить(ВыделенныеСтроки[0]);
...
Процедура РазъединитьСтрокуДетальныеЗаписи(Команда)
	...
	СтрокаКонтрагента = Объект.ДетальныеЗаписи.Вставить(ВыделенныеСтроки[0]);
