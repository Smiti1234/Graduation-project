...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ТабличныеЧасти.Добавить(ПрочиеРасходы);
	ТабличныеЧасти.Добавить(ОплатаПоставщикам);
	...
	Для каждого ТабличнаяЧасть Из ТабличныеЧасти Цикл
		Для каждого СтрокаТЧ Из ТабличнаяЧасть Цикл
			Если ЗначениеЗаполнено(СтрокаТЧ.Валюта) Тогда
				Если ТипЗнч(ТабличнаяЧасть) = Тип("ДокументТабличнаяЧасть.АвансовыйОтчет.ПрочиеРасходы") И СтрокаТЧ.Отменено Тогда
					Продолжить;
				КонецЕсли;
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	СтруктураДействий = Новый Структура("ПересчитатьСуммуСНДС", Новый Структура("ЦенаВключаетНДС", Истина));
