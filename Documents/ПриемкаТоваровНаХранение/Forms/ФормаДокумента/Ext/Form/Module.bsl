...
Процедура ЗаполнитьВалютуПоДоговору()
	...
	Если ЗначениеЗаполнено(Объект.Договор) Тогда
		...
		КонецЕсли;
		Если Не Элементы.Валюта.РежимВыбораИзСписка Тогда
			Элементы.Валюта.СписокВыбора.Очистить();
			Элементы.Валюта.СписокВыбора.Добавить(ВалютаДоговора);
			Элементы.Валюта.РежимВыбораИзСписка = Истина;
		КонецЕсли;
	ИначеЕсли Элементы.Валюта.РежимВыбораИзСписка Тогда
		Элементы.Валюта.СписокВыбора.Очистить();
		Элементы.Валюта.РежимВыбораИзСписка = Ложь;
	КонецЕсли;
