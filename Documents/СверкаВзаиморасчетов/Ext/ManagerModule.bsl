...
Функция ИнициализироватьМенеджерТаблиц(МассивОбъектов)
	...
	РеквизитыОтветственныеЛица = СтруктураРеквизитыОтветственныеЛица();
	...
	Иначе
		ОтветственныеЛицаСервер.СформироватьВременнуюТаблицуОтветственныхЛицДокументов(Документы.СверкаВзаиморасчетов.ПустаяСсылка(), МенеджерВременныхТаблиц,, РеквизитыОтветственныеЛица);
	КонецЕсли;
	
	РеквизитыОтветственныеЛицаОрганизацииКонтрагента = СтруктураРеквизитыОтветственныеЛицаОрганизацииКонтрагента();
