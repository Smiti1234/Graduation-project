...
Процедура РазбитьСтрокуЗавершение(НоваяСтрока, ДополнительныеПараметры) Экспорт
	...
	Если НоваяСтрока <> Неопределено Тогда
		...
		ОбновитьДанные(ТекущиеДанные.Количество, Новый Структура(
			"ИмяПоля, ИдентификаторСтроки", "ТоварыКоличество", ТекущиеДанные.ПолучитьИдентификатор()));
		ОбновитьДанные(НоваяСтрока.Количество, Новый Структура(
			"ИмяПоля, ИдентификаторСтроки", "ТоварыКоличество", НоваяСтрока.ПолучитьИдентификатор()));
