...
Функция РеквизитыУчастника(Участник)
	...
	Если ЗначениеЗаполнено(Участник) Тогда
		РеквизитыУчастника = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Участник, "ИНН, НаименованиеПолное");
	Иначе
		РеквизитыУчастника = Новый Структура("ИНН, НаименованиеПолное");
	КонецЕсли;
