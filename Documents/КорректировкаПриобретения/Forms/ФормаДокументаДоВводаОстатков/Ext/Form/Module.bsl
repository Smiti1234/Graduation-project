...
Процедура ЗаполнитьДанныеКорректировкиСервер()
	...
	Объект.Товары.Очистить();
	Объект.Расхождения.Очистить();
	Документы.КорректировкаПриобретения.ЗаполнитьТоварыПоИсходнымДанным(Объект.ДокументОснование, Объект.Товары);
	ЗагрузитьТаблицуКорректировкиИзДанныхДокументаНаСервере();
	ПриЧтенииСозданииНаСервере();
...
Процедура ПолучитьСтрокиИзБуфераОбмена()
	...
	Колонки = "Номенклатура,Характеристика,Содержание,Упаковка,КоличествоУпаковок,Количество,Цена,НомерГТД,Склад,
		...
		|ВариантОтражения,Серия,СписатьНаРасходы";
...
Процедура УстановитьВидимостьКоличестваРНПТ()
	...
	Элементы.ТаблицаКорректировкиГруппаКоличествоПоРНПТ.Видимость	= Элементы.ТаблицаКорректировкиГруппаКоличествоПоРНПТ.Видимость
																		И Не КорректировкаПриобретенияУслугПрочихАктивов;
