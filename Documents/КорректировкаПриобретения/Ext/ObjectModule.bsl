...
Процедура ЗаполнитьПоПервичномуДокументу(Знач ДокументОснование, ДанныеЗаполнения)
	...
	|	ПервичныйДокумент.НомерВходящегоДокумента КАК НомерВходящегоДокумента,
	|	ПервичныйДокумент.ДатаВходящегоДокумента КАК ДатаВходящегоДокумента,
	...
	|	ПервичныйДокумент.НаименованиеВходящегоДокумента КАК НаименованиеВходящегоДокумента,
...
Процедура ЗаполнитьВидыЗапасов(Отказ)
	...
	ПерезаполнитьВидыЗапасов = Не Проведен
								...
								Или ПроверитьИзменениеТоваров(МенеджерВременныхТаблиц)
									...
									Или ИспользоватьПервичныйДокумент;
