...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если Инициализация Или СтруктураРеквизитов.Свойство("Операция") Тогда
		...
		Элементы.ГруппаДанныеОтчетаДополнительныеСведения.Видимость = РедактированиеДополнительныхСведений И Не ЭтоПиво;
		Элементы.ТоварыКодТНВЭД.Видимость         = РедактированиеДополнительныхСведений И Не ЭтоПиво;
