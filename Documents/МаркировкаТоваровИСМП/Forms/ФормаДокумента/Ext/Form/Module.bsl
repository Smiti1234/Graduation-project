...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.ДатаПроизводства.Видимость = (ЭтоКонтрактноеПроизводство
		...
		Или ЭтоОперацияНанесения И ДляВидаПродукцииИспользуетсяДатаПроизводства)
	...
	Элементы.ДатаПроизводства.АвтоОтметкаНезаполненного =
		ДляВидаПродукцииИспользуетсяДатаПроизводства
			И (ЭтоОперацияНанесения Или ЗначениеЗаполнено(ОперацияНанесения))
...
Процедура ЗаполнитьДоступныеОперации()
	...
	ВидыПродукцииОперацииИмпортСФТС.Вставить(Перечисления.ВидыПродукцииИС.Антисептики, Истина);
	ВидыПродукцииОперацииИмпортСФТС.Вставить(Перечисления.ВидыПродукцииИС.КреслаКоляски, Истина);
	ВидыПродукцииОперацииИмпортСФТС.Вставить(Перечисления.ВидыПродукцииИС.СоковаяПродукция, Истина);
