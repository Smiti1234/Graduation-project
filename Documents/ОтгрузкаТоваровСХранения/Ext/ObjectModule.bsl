...
Процедура ЗаполнитьДокументНаОснованииПриемкиТоваровНаХранение(Знач ДокументОснование)
	...
	|	ВЫБОР
	|		КОГДА ИСТИНА
	|			ТОГДА ПриемкаТоваровНаХранение.СуммаДокумента
...
Процедура ЗаполнитьДопКолонкиВидовЗапасов() Экспорт
	...
	ТаблицаТовары = Товары.Выгрузить(, "АналитикаУчетаНоменклатуры, Упаковка, ДокументПоступления, КоличествоУпаковок, Количество, Цена, Сумма");
	ТаблицаТовары.Свернуть("АналитикаУчетаНоменклатуры, Упаковка, ДокументПоступления, Цена", "Количество, КоличествоУпаковок, Сумма");
