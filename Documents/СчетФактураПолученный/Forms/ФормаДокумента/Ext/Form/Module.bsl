...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Если ЗначениеЗаполнено(ДокументОснование)
		...
		Если ДокументОснование.ТипПервичногоДокумента = Перечисления.ТипыПервичныхДокументов.ЗакупкаЧерезПодотчетноеЛицо Тогда
			ОформленПоАвансовомуОтчету = Истина;
		ИначеЕсли ДокументОснование.ТипПервичногоДокумента = Перечисления.ТипыПервичныхДокументов.ПриобретениеУПоставщика Тогда
			ВводОстатков = Истина;
		КонецЕсли;
	КонецЕсли;
