...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	ПроверитьНаличиеДублейСтрокВТаблице(Отказ);
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("ДокументСсылка.ПервичныйДокумент") Тогда
...
&НаКлиенте
Процедура ТаблицаКорректировкиНомерГТДОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
...
Процедура ЗаполнитьДанныеКорректировкиСервер()
	...
	Документы.КорректировкаРеализации.ЗаполнитьТоварыПоИсходнымДанным(Объект.ДокументОснование, Объект.Товары, Объект.Ссылка);
	ЗагрузитьТаблицуКорректировкиИзДанныхДокументаНаСервере();
	ПриЧтенииСозданииНаСервере();
...
&НаКлиентеНаСервереБезКонтекста
Процедура ДобавитьВСтруктуруДействияПриИзмененииКоличества(СтруктураДействий, Объект, Суффикс = "")
...
&НаСервере
Процедура ПроверитьНаличиеДублейСтрокВТаблице(Отказ)
...
Процедура ОчиститьСлужебныеДанныеСписываемыхИмпортныхТоваров()
	...
	Для Каждого СтрокаТЧ Из ТаблицаКорректировки Цикл
		Если СтрокаТЧ.СтавкаНДС = СтрокаТЧ.СтавкаНДСПосле
