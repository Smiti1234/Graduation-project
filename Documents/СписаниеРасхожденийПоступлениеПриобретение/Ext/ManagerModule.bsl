...
Функция ТекстЗапросаТаблицаТоварыОрганизаций(Запрос, ТекстыЗапроса, Регистры)
	...
	|			(ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Товар),
	|			ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара))
	|	И (ТаблицаРасхождений.Номенклатура.ПрослеживаемыйТовар ИЛИ ТаблицаРасхождений.Номенклатура.ВестиУчетПоГТД)
	|	И ТаблицаРасхождений.Номенклатура.ТипНоменклатуры В 
	|			(ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Товар),
	|			ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара))
	|	И &ХозяйственнаяОперацияКПоступлению В (
...
Функция ПечатьАктаСписанияРасхождений(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаДокументы.Следующий() Цикл
		...
		Пока ВыборкаПоСтрокам.Следующий() Цикл
			...
			// Номенклатура.
			ОбластьТоварСтрока.Параметры.ВидРасхождения = ВыборкаПоСтрокам.ВидРасхождения;
