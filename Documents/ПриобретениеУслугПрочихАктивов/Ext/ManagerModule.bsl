...
Процедура СформироватьСуммыДокументаВВалютахУчета(Запрос, ТекстыЗапроса, Регистры = Неопределено) Экспорт
	...
	|	ВЫБОР КОГДА ТаблицаДокумента.Ссылка.ДатаКурсаВалютыДокумента <> ДАТАВРЕМЯ(1, 1, 1)
	|			ТОГДА ТаблицаДокумента.Ссылка.ДатаКурсаВалютыДокумента
...
Процедура ДобавитьТекстыОтраженияВзаиморасчетов(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапросаКурсыВалютДокумента = 
		...
		|ИЗ
		|	Документ.ПриобретениеУслугПрочихАктивов КАК ДанныеДокументаШапка
		|ГДЕ
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПриобретениеУслугПрочихАктивов КАК ДанныеДокументаШапка
	...
	ТекстЗачетАванса = "
		...
		|	ВЫБОР
		|		КОГДА Таблица.Ссылка.ДатаКурсаВалютыДокумента = ДАТАВРЕМЯ(1,1,1)
		|			ТОГДА Таблица.Ссылка.Дата
		|		ИНАЧЕ Таблица.Ссылка.ДатаКурсаВалютыДокумента
		|	КОНЕЦ                                                                    КАК ДатаКурса,
