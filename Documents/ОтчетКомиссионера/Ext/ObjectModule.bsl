		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
			...
			Если КоличествоТоваров = 0 Тогда
				Если СуммаСНДСПоСтроке <> 0 Тогда
					НоваяСтрока.СуммаСНДС = НоваяСтрока.СуммаСНДС + СуммаСНДСПоСтроке;
				КонецЕсли;
				
				Если СуммаНДСПоСтроке <> 0 Тогда
					НоваяСтрока.СуммаНДС = НоваяСтрока.СуммаНДС + СуммаНДСПоСтроке;
				КонецЕсли;
				
				Если СуммаВознагражденияПоСтроке <> 0 Тогда
					НоваяСтрока.СуммаВознаграждения = НоваяСтрока.СуммаВознаграждения + СуммаВознагражденияПоСтроке;
				КонецЕсли;
				
				Если СуммаВознагражденияПоСтроке <> 0 Тогда
					НоваяСтрока.СуммаНДСВознаграждения = НоваяСтрока.СуммаНДСВознаграждения + СуммаВознагражденияПоСтроке;
				КонецЕсли;
