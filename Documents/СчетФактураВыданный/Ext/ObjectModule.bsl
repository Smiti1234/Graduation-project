...
Функция ТаблицаТоваров(ДанныеЗаполнения = Неопределено) Экспорт
	...
	СчетФактураОтбора = ?(ТипЗнч(ДанныеЗаполнения) = Тип("Структура") И ДанныеЗаполнения.Свойство("СчетФактураОтбора"),
		ДанныеЗаполнения.СчетФактураОтбора, ?(ОтборПоСчетуФактуре, СчетФактураОснование, Неопределено));
