...
Процедура СоздатьДокументыСчетФактура(Основания, ДополнительныеПараметры)
	...
	Если ТипЗнч(СтруктураЗаполнения.ДокументОснование) = Тип("Массив") Тогда 
		РеквизитыСчетаФактуры = ОбщегоНазначенияУТВызовСервера.ЗначенияРеквизитовОбъекта(СтруктураЗаполнения.ДокументОснование[0], "Организация, Контрагент");
	Иначе
		РеквизитыСчетаФактуры = ОбщегоНазначенияУТВызовСервера.ЗначенияРеквизитовОбъекта(СтруктураЗаполнения.ДокументОснование, "Организация, Контрагент");
	КонецЕсли;
	
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("ДокументОснование", СтруктураЗаполнения.ДокументОснование);
	ПараметрыОткрытия.Вставить("Организация",       РеквизитыСчетаФактуры.Организация);
	ПараметрыОткрытия.Вставить("Контрагент",        РеквизитыСчетаФактуры.Контрагент);
	...
	Если ДополнительныеПараметры.Исправление Тогда
		...
		Иначе
			...
			+ НСтр("ru = 'Необходимо зарегистрировать по документам-основаниям отдельные счета-фактуры.'") + Символы.ПС 
