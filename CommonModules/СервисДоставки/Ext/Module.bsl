...
//
Функция ПолучитьИдентификаторСервисаБизнесСеть() Экспорт
...
Функция ЗапросСервисаПолучитьСостояниеОпцииКурьерика(ПараметрыЗапроса, Отказ = Неопределено) Экспорт
