...
Функция ОсобенностиУчетаНоменклатуры() Экспорт
	...
	Массив.Добавить(Перечисления.ВидыПродукцииИС.ЗерноВЕТИС);
	Массив.Добавить(Перечисления.ВидыПродукцииИС.ПродуктыПереработкиЗернаВЕТИС);
	Массив.Добавить(Перечисления.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС);
