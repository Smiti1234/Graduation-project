...
#Если МобильноеПриложениеСервер Тогда
	...
	Драйвер.Наименование = НСтр("ru = 'RightScan:Устройства ввода данных ТСД Urovo'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Сканкод:Cканер штрихкода Chipherlab ТСД'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ScanPort:Устройства ввода данных ТСД'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Скансити:Устройства ввода данных ТСД'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Клеверенс:Драйвер ТСД для мобильной платформы 1С'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Устройства ввода данных ТСД'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'MERTECH:Сканер штрихкода ТСД'", ОбщегоНазначения.КодОсновногоЯзыка());
