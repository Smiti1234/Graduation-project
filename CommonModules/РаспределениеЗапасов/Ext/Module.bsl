...
//
Процедура ВыполнитьРаспределениеВФоне(Задания, ИдентификаторыНеОбработанныхЗаписей) Экспорт
	...
	Если Не ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Неопределено, "РегистрСведений.РаспределениеЗапасов") Тогда
		...
		ИсточникДанныхБлокировки = Запрос.МенеджерВременныхТаблиц.Таблицы["ТоварыДляРаспределенияЗапасов"].ПолучитьДанные().Выгрузить();
