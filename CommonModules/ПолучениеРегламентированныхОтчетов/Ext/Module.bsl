...
//
Процедура НастроитьОбновленияРегламентированныхОтчетов(Параметры = Неопределено) Экспорт
...
Функция ОписаниеДанныхРегламентированныхОтчетов()
	...
	ДанныеРегламентированныхОтчетов.Колонки.Добавить("Наименование",            ОбщегоНазначения.ОписаниеТипаСтрока(100));
...
Функция ЗначениеСвойстваJSON(ОбъектJSON, ИмяСвойства, ЗначениеПоУмолчанию = Неопределено)
	...
	ОбъектJSON.Свойство(ИмяСвойства, Значение);
