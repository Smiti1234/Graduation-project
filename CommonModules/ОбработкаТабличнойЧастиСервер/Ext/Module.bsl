...
Процедура ПроверитьКорректностьЗаполнитьХарактеристикиКиЗ(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения) Экспорт
...
Функция МетодыКВыполнению(СтруктураДействий)
	...
	Соответствие.Добавить("ПроверитьХарактеристикуКиЗПоВладельцу",						"ОбработкаТабличнойЧастиСервер.ПроверитьКорректностьЗаполнитьХарактеристикиКиЗ");
	...
	Соответствие.Добавить("ПересчитатьСуммуСверхЗаказа",								"ОбработкаТабличнойЧастиКлиентСервер.ПересчитатьСуммуСверхЗаказаВСтрокеТЧ");
