...
Функция КассоваяСсылка(ТорговаяТочка) Экспорт
	...
	Возврат СлужебныйКассоваяСсылка(
		ТорговаяТочка,
		Неопределено);
...
Функция ПроверитьПараметрыПодключения(УчастникСБП, ПараметрыАутентификации) Экспорт
	...
	Для Каждого ОписаниеКлюча Из ПараметрыАутентификации Цикл
		Если ОписаниеКлюча.Значение
			<> ИнтеграцияСПлатежнымиСистемамиСлужебный.УдалитьНечитаемыеСимволы(ОписаниеКлюча.Значение) Тогда
			
			ОписаниеКлюча.Значение = ИнтеграцияСПлатежнымиСистемамиСлужебный.УдалитьНечитаемыеСимволы(ОписаниеКлюча.Значение);
...
Функция ЗаписатьПараметрыПодключения(
	...
	Попытка
		...
		Для Каждого ПараметрАутентификации Из СтруктураНастроекИнтеграции.ПараметрыАутентификации Цикл 
			Если ПараметрАутентификации.Значение
					<> ИнтеграцияСПлатежнымиСистемамиСлужебный.УдалитьНечитаемыеСимволы(ПараметрАутентификации.Значение) Тогда
