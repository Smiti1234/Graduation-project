...
//
Процедура УправлениеВидимостьюКомандПогашенияСДИЗ(Форма, Команды) Экспорт
...
// 	Команды - Структура - структура команд динамически формируемых для создания документов на основании.
//
Процедура УправлениеВидимостьюКомандСписаниеПартийЗЕРНО(Форма, Команды) Экспорт
...
// 	Команды - Структура - структура команд динамически формируемых для создания документов на основании.
//
Процедура УправлениеВидимостьюКомандВнесениеСведенийОСобранномУрожаеЗЕРНО(Форма, Команды) Экспорт
...
// 	Команды - Структура - структура команд динамически формируемых для создания документов на основании.
//
Процедура УправлениеВидимостьюКомандФормированиеПартийПриПроизводствеЗЕРНО(Форма, Команды) Экспорт
