		...
		Если НастройкаСервис <> Неопределено И НастройкаСервис.Активен Тогда
			РезультатОперации.ДанныеУчастников.Вставить(
				...
				Новый Структура("АдресСтраницыПодключения,
					...
					НастройкаСервис.АдресСтраницыЗаявки,
					НастройкаСервис.ПартнерАгентаСБП,
					НастройкаСервис.ПорядокОтображения));
		КонецЕсли;
	КонецЦикла;
...
Функция НастройкиТорговойТочки(ТорговаяТочка, ПлатежнаяСистема) Экспорт
	...
	Настройки.ВыборПлатежнойСистемыВозврата = (
		...
		И ПлатежнаяСистема <> Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк
		И ПлатежнаяСистема <> Перечисления.ПлатежныеСистемы.СБП_CDEKPay
		И ПлатежнаяСистема <> Перечисления.ПлатежныеСистемы.СБП_Тинькофф
		И ПлатежнаяСистема <> Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк);
	...
	Настройки.ПодключениеКассовойСсылки = НастройкиУчастникаСБП.ПодключениеКассовойСсылки;
	...
	Если ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_PayMaster
		...
		Или ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
	...
	Если ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_PayMaster
		...
		Или ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		Настройки.ПлатежныйАгрегатор = Истина;
	КонецЕсли;
	
	Если ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_PayMaster
		Или ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		Настройки.ПодключениеКассовойСсылки = Истина;
	КонецЕсли;
...
Функция ИдентификаторТорговойТочки(ПлатежнаяСистема, НастройкиАутентификации) Экспорт
	...
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		Возврат НастройкиУчастниковСБП.ИдентификаторТорговойТочкиРусскийСтандарт(
			НастройкиАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк Тогда
		Возврат НастройкиУчастниковСБП.ИдентификаторТорговойТочкиРайффайзенбанк(
			НастройкиАутентификации);
	...
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
		Возврат НастройкиУчастниковСБП.ИдентификаторТорговойТочкиCDEKPay(
			НастройкиАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		Возврат НастройкиУчастниковСБП.ИдентификаторТорговойТочкиТинькофф(
			НастройкиАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк Тогда
		Возврат НастройкиУчастниковСБП.ИдентификаторТорговойТочкиТочкаБанк(
			НастройкиАутентификации); 
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
		Возврат НастройкиУчастниковСБП.ИдентификаторТорговойТочкиКубаньКредит(
			НастройкиАутентификации);
	Иначе
...
Процедура НастройкиАутентификации(ПлатежнаяСистема, Реквизиты, Подсказка) Экспорт
	...
	ИначеЕсли ПлатежнаяСистемаПодключаетсяЧерезTTP(ПлатежнаяСистема) Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииTTP(
			...
			ПлатежнаяСистема);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииРусскийСтандарт(
			Реквизиты,
			Подсказка);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииРайффайзенбанк(
			Реквизиты,
			Подсказка);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииCDEKPay(
			Реквизиты,
			Подсказка);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииТинькофф(
			Реквизиты,
			Подсказка);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииТинькофф(
			...
			Подсказка);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииТочкаБанк(
			Реквизиты,
			Подсказка);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
		НастройкиУчастниковСБП.НастройкиАутентификацииКубаньКредит(
			Реквизиты,
			Подсказка);
	КонецЕсли;
...
Процедура СохранитьНастройкиАутентификации(Интеграция, ПараметрыАутентификации, ПлатежнаяСистема) Экспорт
	...
	Для Каждого ПараметрАутентификации Из ПараметрыАутентификации Цикл
		ПараметрыАутентификации.Вставить(
			...
			ИнтеграцияСПлатежнымиСистемамиСлужебный.УдалитьНечитаемыеСимволы(ПараметрАутентификации.Значение));
	КонецЦикла;
	...
	ИначеЕсли ПлатежнаяСистемаПодключаетсяЧерезTTP(ПлатежнаяСистема) Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииTTP(
			...
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииРусскийСтандарт(
			Интеграция,
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииРайффайзенбанк(
			Интеграция,
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииCDEKPay(
			Интеграция,
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииТинькофф(
			Интеграция,
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииТочкаБанк(
			Интеграция,
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
		НастройкиУчастниковСБП.СохранитьНастройкиАутентификацииКубаньКредит(
			Интеграция,
			ПараметрыАутентификации);
	Иначе
		ВызватьИсключение НСтр("ru = 'Неизвестная платежная система.'");
...
Функция ДанныеАутентификацииНастройки(Интеграция, ПлатежнаяСистема) Экспорт
	...
	ИначеЕсли ПлатежнаяСистемаПодключаетсяЧерезTTP(ПлатежнаяСистема) Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиTTP(
			...
			Результат);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиРусскийСтандарт(
			Данные,
			Результат);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиРайффайзенбанк(
			Данные,
			Результат);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиCDEKPay(
			Данные,
			Результат);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиТинькофф(
			Данные,
			Результат);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиТочкаБанк(
			Данные,
			Результат);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
		НастройкиУчастниковСБП.ДанныеАутентификацииНастройкиКубаньКредит(
			Данные,
			Результат);
	Иначе
		ВызватьИсключение НСтр("ru = 'Неизвестная платежная система.'");
...
Функция ДанныеАутентификацииВПлатежнойСистеме(
	...
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ЮгИнвестбанк Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросЮгИнвестбанк(
			...
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросРусскийСтандарт(
			ДанныеАутентификации,
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросРайффайзенбанк(
			ДанныеАутентификации,
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросCDEKPay(
			ДанныеАутентификации,
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема,
			ДанныеДляПодписи);
	ИначеЕсли ПлатежнаяСистемаПодключаетсяЧерезTTP(ПараметрыИнтеграции.ПлатежнаяСистема) Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросTTP(
			...
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросТинькофф(
			ДанныеАутентификации,
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросТочкаБанк(
			ДанныеАутентификации,
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	ИначеЕсли ПараметрыИнтеграции.ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
		Возврат НастройкиУчастниковСБП.ДанныеАутентификацииЗапросКубаньКредит(
			ДанныеАутентификации,
			ПараметрыИнтеграции.ТорговаяТочкаСсылка,
			ПараметрыИнтеграции.ПлатежнаяСистема);
	Иначе
...
Функция ЗаголовокАутентификацииПоДаннымАутентификации(
	...
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_СКБ
		...
		Или ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
	...
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Промсвязьбанк
		Или ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
...
Функция ПреобразоватьНастройкиАутентификации(ПлатежнаяСистема, ПараметрыАутентификации)
	...
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ЮгИнвестбанк Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииЮгИнвестбанк(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_РусскийСтандарт Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииРусскийСтандарт(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Райффайзенбанк Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииРайффайзенбанк(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_CDEKPay Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииCDEKPay(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_Тинькофф Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииТинькофф(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_ТочкаБанк Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииТочкаБанк(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистема = Перечисления.ПлатежныеСистемы.СБП_КубаньКредит Тогда
		Возврат НастройкиУчастниковСБП.ПреобразоватьНастройкиАутентификацииКубаньКредит(
			ПараметрыАутентификации);
	ИначеЕсли ПлатежнаяСистемаПодключаетсяЧерезTTP(ПлатежнаяСистема) Тогда
...
Функция ПлатежныеАгрегаторы() Экспорт
	...
	Возврат УчастникиСБППоНастройкам(КлючиПоиска);
...
Функция ПоддержкаКассовыхСсылок() Экспорт
	...
	УчастникиСБП = УчастникиСБППоНастройкам(КлючиПоиска);
...
// Возвращает массив участников СБП, которые поддерживают функционал сверки взаиморасчетов.
//
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ПлатежныеСистемы - список участников СБП с поддержкой кассовых ссылок.
//
Функция ПоддержкаСверкиВзаиморасчетов() Экспорт
...
//
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ПлатежныеСистемы - список участников СБП с поддержкой функциональности.
//
Функция УчастникиСБППоНастройкам(КлючиПоиска)
...
Функция ОперацияПолучениеНастроекУчастниковСБП()
	...
	Для Каждого ОписаниеНастройки Из ДанныеНастроек Цикл
		...
		Настройка.Вставить("АдресСтраницыПодключения", ОписаниеНастройки.personalAccountPageUrl);
		Настройка.Вставить("БИК", ОписаниеНастройки.biks);
		Настройка.Вставить("АдресСтраницыЗаявки", АдресСтраницыПодключенияКСБП(ОписаниеНастройки.memberId));
		Настройка.Вставить("ПартнерАгентаСБП",
			?(ОписаниеНастройки.Свойство("c2bSbpAgentPartner"),
				ОписаниеНастройки.c2bSbpAgentPartner,
				Ложь));
		Настройка.Вставить("ПорядокОтображения",
			?(ОписаниеНастройки.sortingOrder <> Неопределено,
				ОписаниеНастройки.sortingOrder,
				0));
...
Процедура УстановитьАтрибутыАрхива(ПутьКАрхиву)
	...
	Для НомерФайла = 1 По КоличествоФайлов Цикл
		...
		ВерсияФайлаDec = БуферДиректории.ПрочитатьЦелое16(
			4,
			ПорядокБайтов.LittleEndian);
		ВерсияФайлаHex = ПреобразоватьЧислоВHEX(ВерсияФайлаDec);
