...
//
// Параметры:
//   УзелПланаОбмена - ПланОбменаОбъект - Ссылка на план обмена.
//   Реквизиты - Структура - Регистрируемые ссылки реквизитов плана обмена.
//
Процедура ПриПереопределенииРеквизитовСсылочногоТипаУзлаПланаОбмена(УзелПланаОбмена, Реквизиты) Экспорт
	Если ТипЗнч(УзелПланаОбмена) = Тип("ПланОбменаОбъект.СинхронизацияДанныхЧерезУниверсальныйФормат") 
		...
		Если Реквизиты.Свойство("УправленческаяОрганизация") Тогда
			Реквизиты.Удалить("УправленческаяОрганизация");
		КонецЕсли;
	КонецЕсли;	
КонецПроцедуры
