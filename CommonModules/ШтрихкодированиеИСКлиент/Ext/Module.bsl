...
Процедура УточненияДанныхЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ПараметрыСканирования.Свойство("ККТФФД12ИСМП")
		...
		ВидПродукцииПиво = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Пиво");
		Если ДанныеШтрихкода.ВидПродукции = ВидПродукцииПиво
			И ТипЗнч(ДанныеШтрихкода) = Тип("Структура")
