...
Функция ДанныеЗаполненияНакладнаяСАТУРН(ОрганизацияСАТУРН) Экспорт
	...
	ЗаполнитьПоСтатистике(
		"ГрузоотправительМестоХранения, ГрузополучательОрганизацияСАТУРН, ГрузополучательМестоХранения",
		ДанныеЗаполнения,
