...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи, Форма) Экспорт
	//++ Локализация
	ЗаписатьРегистрацииВНалоговомОргане(ТекущийОбъект, Отказ, Форма);
	//-- Локализация
КонецПроцедуры
...
Процедура ЗаписатьРегистрацииВНалоговомОргане(ТекущийОбъект, Отказ, Форма)
	...
	РегистрацииВНалоговомОргане.Загрузить(Форма.РегистрацииВНалоговомОрганеНаборЗаписей.Выгрузить());
	РегистрацииВНалоговомОргане.Записать();
...
Процедура ОбновитьРегистрацииВНалоговомОрганеПослеРедактирования(РезультатРедактирования, Форма)
	...
	Если КоличествоЗаписейИстории > 0 Тогда
		...
		Если КоличествоЗаписейИстории > 0 Тогда
			АктуальнаяЗапись = Форма.РегистрацииВНалоговомОрганеНаборЗаписей[КоличествоЗаписейИстории - 1];
			Если Форма.РегистрацияВНалоговомОргане <> АктуальнаяЗапись.РегистрацияВНалоговомОргане Тогда
...
Процедура ЗаписатьРегистрациюВНалоговомОргане(Форма) Экспорт
	
    Объект = Форма.Объект;
	РегистрацияВНалоговомОргане = Форма.РегистрацияВНалоговомОргане;
	...
	Объект.РегистрацияВНалоговомОргане = РегистрацияОбъект.Ссылка;
