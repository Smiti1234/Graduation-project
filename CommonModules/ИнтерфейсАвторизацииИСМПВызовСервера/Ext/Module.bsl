...
Функция ТребуетсяОбновлениеКлючаСессииСУчетомВидаТокена(ПараметрыСканирования, ВидМаркируемойПродукции = Неопределено, Знач СрокДействия = Неопределено) Экспорт
	...
	Если ВидМаркируемойПродукции = Неопределено Тогда
		...
		Иначе
			...
			Для Каждого ДопустимыйВидПродукции Из ПараметрыСканирования.ДопустимыеВидыПродукции Цикл
				...
				КлючСессииНеОбновлен = ТребуетсяОбновлениеКлючаСессииСУчетомВидаТокена(ПараметрыСканирования, ДопустимыйВидПродукции);
				
				Если КлючСессииНеОбновлен Тогда
	...
	Возврат ТребуетсяОбновлениеКлючаСессии(ПараметрыЗапроса, СрокДействия);
