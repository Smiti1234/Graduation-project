...
//
Функция ОсновнойПредмет(ЗадачаXDTO) Экспорт
...
//
Функция РезультатДействия(РезультатДействияСтрока, ДанныеДляОбновления) Экспорт
...
Процедура ДействияИзXDTO(ОбъектXDTO, Строки, КоличествоДействий)
	...
	Для Каждого СтрокаXDTO Из ОбъектXDTO.actionsRows.rows Цикл
		...
		НоваяСтрока.НомерКартинки = СтрокаXDTO.imageIndex;
