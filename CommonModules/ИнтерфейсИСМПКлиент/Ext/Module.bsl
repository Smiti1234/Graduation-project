...
Процедура ПолучитьИдентификаторыЗапросаГИСМТПриРозничнойПродаже(ОповещениеПослеЗавершения, ЭлементПроверки, ПараметрыСканирования) Экспорт
	...
	РезультатДанных = ИнтерфейсИСМПВызовСервера.ПолучитьСокращеннуюИнформациюПоКМ(ЭлементПроверки.ПолныйКодМаркировки,
		НормализованныйШтрихкод,
		ЭлементПроверки.ВидПродукции,
		ПараметрыСканирования);
		
	ВыполнитьОбработкуОповещения(ОповещениеПослеЗавершения, РезультатДанных);
