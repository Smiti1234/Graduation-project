	...
	Если РезультатФормирования.Свойство("ЕГРЮЛ")
		...
		Если РезультатФормирования.ЕГРЮЛ.Свойство("ИсторияРеквизитов") Тогда
			...
			Если РезультатФормирования.ЕГРЮЛ.ИсторияРеквизитов.Свойство("Наименование") Тогда
				...
				КоличествоЗаписейИстории = РезультатФормирования.ЕГРЮЛ.ИсторияРеквизитов.Наименование.Количество();
				...
				Для Каждого СтрокаИстории Из РезультатФормирования.ЕГРЮЛ.ИсторияРеквизитов.Наименование Цикл
					...
					Если Не ЗначениеЗаполнено(СтрокаИстории.НаименованиеСокращенноеНаАнглийском) Тогда 
						Если СтрокаИстории = РезультатФормирования.ЕГРЮЛ.ИсторияРеквизитов.Наименование[КоличествоЗаписейИстории-1] 
							И ЗначениеЗаполнено(РезультатПреобразования.НаименованиеМеждународное) Тогда
							ДанныеНаименования.Вставить("НаименованиеМеждународное", РезультатПреобразования.НаименованиеМеждународное);
						КонецЕсли;
					Иначе
						ДанныеНаименования.Вставить("НаименованиеМеждународное", СтрокаИстории.НаименованиеСокращенноеНаАнглийском);
					КонецЕсли;
