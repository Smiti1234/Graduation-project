...
Процедура НастройкиАутентификации1ССБП(Реквизиты, Подсказка) Экспорт
	...
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните настройки."
		+ " Получить данные для настройки можно в <a href=""%1"">1С:СБП</a>."
		+ Символы.ПС
		+ Символы.ПС
		+ "Список доступных к подключению банков можно "
...
Процедура НастройкиАутентификацииЮМани(Реквизиты, Подсказка) Экспорт
	...
	Реквизиты.Добавить(
		ИнтеграцияСПлатежнымиСистемамиСлужебный.НовыйОписаниеРеквизита(
			...
			Истина));
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните настройки."
		+ " Получить данные для настройки можно в <a href=""%1"">ЮKassa (ООО НКО ""ЮМани"")</a>.'");
...
//
// Возвращаемое значение:
//  Строка - идентификатор Модульбанк.
//
...
// См. СервисИнтеграцииССБП.ИдентификаторТорговойТочки.
//
Функция ИдентификаторТорговойТочкиРайффайзенбанк(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.НастройкиАутентификации.
//
Процедура НастройкиАутентификацииРайффайзенбанк(Реквизиты, Подсказка) Экспорт
	...
	Реквизиты.Добавить(
		ИнтеграцияСПлатежнымиСистемамиСлужебный.НовыйОписаниеРеквизита(
			...
			Истина));
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните настройки."
		+ " Получить данные для настройки можно в <a href=""%1"">Агенте 1С:СБП</a> для Райффайзен Банк.'");
	
КонецПроцедуры

// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Функция ДанныеАутентификацииЗапросРайффайзенбанк(
		ДанныеАутентификации,
		ТорговаяТочка,
		ПлатежнаяСистема) Экспорт
...
// См. СервисИнтеграцииССБП.СохранитьНастройкиАутентификации.
//
Процедура СохранитьНастройкиАутентификацииРайффайзенбанк(Интеграция, ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Процедура ДанныеАутентификацииНастройкиРайффайзенбанк(Данные, Результат) Экспорт
...
// См. СервисИнтеграцииССБП.ПреобразоватьНастройкиАутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииРайффайзенбанк(ПараметрыАутентификации) Экспорт
...
#Область РусскийСтандарт

// См. СервисИнтеграцииССБП.ИдентификаторТорговойТочки.
//
Функция ИдентификаторТорговойТочкиРусскийСтандарт(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.НастройкиАутентификации.
//
Процедура НастройкиАутентификацииРусскийСтандарт(Реквизиты, Подсказка) Экспорт
	...
	Реквизиты.Добавить(
		ИнтеграцияСПлатежнымиСистемамиСлужебный.НовыйОписаниеРеквизита(
			...
			Истина));
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните"
		+ " настройки или отправьте <a href=""%1"">заявку на подключение</a> в Банк Русский Стандарт.'");
	
КонецПроцедуры

// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Функция ДанныеАутентификацииЗапросРусскийСтандарт(
		ДанныеАутентификации,
		ТорговаяТочка,
		ПлатежнаяСистема) Экспорт
...
// См. СервисИнтеграцииССБП.СохранитьНастройкиАутентификации.
//
Процедура СохранитьНастройкиАутентификацииРусскийСтандарт(Интеграция, ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Процедура ДанныеАутентификацииНастройкиРусскийСтандарт(Данные, Результат) Экспорт
...
// См. СервисИнтеграцииССБП.ПреобразоватьНастройкиАутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииРусскийСтандарт(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ИдентификаторТорговойТочки.
//
Функция ИдентификаторТорговойТочкиCDEKPay(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.НастройкиАутентификации.
//
Процедура НастройкиАутентификацииCDEKPay(Реквизиты, Подсказка) Экспорт
	...
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните"
		+ " настройки или отправьте <a href=""%1"">заявку на подключение</a> в СДЭК Финанс.'");
	
КонецПроцедуры

// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Функция ДанныеАутентификацииЗапросCDEKPay(
		ДанныеАутентификации,
		ТорговаяТочка,
		ПлатежнаяСистема,
		ДанныеДляПодписи) Экспорт
...
// См. СервисИнтеграцииССБП.СохранитьНастройкиАутентификации.
//
Процедура СохранитьНастройкиАутентификацииCDEKPay(Интеграция, ПараметрыАутентификации) Экспорт
	...
	ОбщегоНазначения.ЗаписатьДанныеВБезопасноеХранилище(
		Интеграция,
		ПреобразоватьНастройкиАутентификацииCDEKPayСохранение(
			ПараметрыАутентификации));
...
// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Процедура ДанныеАутентификацииНастройкиCDEKPay(Данные, Результат) Экспорт
...
//  Структура - преобразованные настройки аутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииCDEKPayСохранение(ПараметрыАутентификации)
...
// См. СервисИнтеграцииССБП.ПреобразоватьНастройкиАутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииCDEKPay(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ИдентификаторТорговойТочки.
//
Функция ИдентификаторТорговойТочкиТинькофф(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.НастройкиАутентификации.
//
Процедура НастройкиАутентификацииТинькофф(Реквизиты, Подсказка) Экспорт
	...
	Реквизиты.Добавить(
		ИнтеграцияСПлатежнымиСистемамиСлужебный.НовыйОписаниеРеквизита(
			...
			Истина));
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните настройки."
		+ " Получить данные для настройки можно в <a href=""%1"">Агенте 1С:СБП</a> для Тинькофф.'");
	
КонецПроцедуры

// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Функция ДанныеАутентификацииЗапросТинькофф(
		ДанныеАутентификации,
		ТорговаяТочка,
		ПлатежнаяСистема) Экспорт
...
// См. СервисИнтеграцииССБП.СохранитьНастройкиАутентификации.
//
Процедура СохранитьНастройкиАутентификацииТинькофф(Интеграция, ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Процедура ДанныеАутентификацииНастройкиТинькофф(Данные, Результат) Экспорт
...
// См. СервисИнтеграцииССБП.ПреобразоватьНастройкиАутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииТинькофф(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ИдентификаторТорговойТочки.
//
Функция ИдентификаторТорговойТочкиТочкаБанк(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.НастройкиАутентификации.
//
Процедура НастройкиАутентификацииТочкаБанк(Реквизиты, Подсказка) Экспорт
	...
	Реквизиты.Добавить(
		ИнтеграцияСПлатежнымиСистемамиСлужебный.НовыйОписаниеРеквизита(
			...
			Истина));
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните"
		+ " настройки или отправьте <a href=""%1"">заявку на подключение</a> в Точка Банк.'");
	
КонецПроцедуры

// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Функция ДанныеАутентификацииЗапросТочкаБанк(
		ДанныеАутентификации,
		ТорговаяТочка,
		ПлатежнаяСистема) Экспорт
...
// См. СервисИнтеграцииССБП.СохранитьНастройкиАутентификации.
//
Процедура СохранитьНастройкиАутентификацииТочкаБанк(Интеграция, ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Процедура ДанныеАутентификацииНастройкиТочкаБанк(Данные, Результат) Экспорт
...
// См. СервисИнтеграцииССБП.ПреобразоватьНастройкиАутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииТочкаБанк(ПараметрыАутентификации) Экспорт
...
#Область КубаньКредит

// См. СервисИнтеграцииССБП.ИдентификаторТорговойТочки.
//
Функция ИдентификаторТорговойТочкиКубаньКредит(ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.НастройкиАутентификации.
//
Процедура НастройкиАутентификацииКубаньКредит(Реквизиты, Подсказка) Экспорт
	...
	Реквизиты.Добавить(
		ИнтеграцияСПлатежнымиСистемамиСлужебный.НовыйОписаниеРеквизита(
			...
			Истина));
	Подсказка = НСтр("ru = 'Для подключения к Системе быстрых платежей заполните"
		+ " настройки или отправьте <a href=""%1"">заявку на подключение в </a>Кубань Кредит.'");
	
КонецПроцедуры

// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Функция ДанныеАутентификацииЗапросКубаньКредит(
		ДанныеАутентификации,
		ТорговаяТочка,
		ПлатежнаяСистема) Экспорт
...
// См. СервисИнтеграцииССБП.СохранитьНастройкиАутентификации.
//
Процедура СохранитьНастройкиАутентификацииКубаньКредит(Интеграция, ПараметрыАутентификации) Экспорт
...
// См. СервисИнтеграцииССБП.ДанныеАутентификацииВПлатежнойСистеме.
//
Процедура ДанныеАутентификацииНастройкиКубаньКредит(Данные, Результат) Экспорт
...
// См. СервисИнтеграцииССБП.ПреобразоватьНастройкиАутентификации.
//
Функция ПреобразоватьНастройкиАутентификацииКубаньКредит(ПараметрыАутентификации) Экспорт
