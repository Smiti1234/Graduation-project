...
Процедура ПриСозданииНаСервере_НастройкиНоменклатуры(Форма) Экспорт
	...
	ЭлементыФормы.ЛокализацияГруппаВариантыПроверкиСтатусовСертификатовНоменклатурыРосаккредитации.Видимость = 
		ЭлементыФормы.ГруппаИспользоватьСертификаты.Видимость;
	
	Если Не ОбщегоНазначения.РазделениеВключено()
		И Пользователи.ЭтоПолноправныйПользователь(, Истина) Тогда
		
		ОпределитьНастройкиРегламентногоЗаданияОбновленияСтатусовСертификатовНоменклатурыРосаккредитации(Форма);
		
	Иначе
		ЭлементыФормы.ОткрытьНастройкуРасписанияОбновленияСтатусовСертификатовНоменклатурыРосаккредитации.Видимость = Ложь;
	КонецЕсли;
...
Процедура УстановитьДоступность_НастройкиНоменклатуры(РеквизитПутьКДанным, Форма) Экспорт
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьСертификатыНоменклатуры"
		...
		Элементы.ЛокализацияГруппаВариантыПроверкиСтатусовСертификатовНоменклатурыРосаккредитации.Доступность =
			НаборКонстант.ИспользоватьСертификатыНоменклатуры;
		
	КонецЕсли;
	
	Если РеквизитПутьКДанным = "НаборКонстант.ВариантПроверкиСтатусовСертификатовНоменклатурыРосаккредитации"
		Или РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ОткрытьНастройкуРасписанияОбновленияСтатусовСертификатовНоменклатурыРосаккредитации.Доступность =
			...
			И ЗначениеКонстанты <> Перечисления.ВариантыПроверкиСтатусовСертификатовНоменклатурыРосаккредитации.НеПроверять;
...
Процедура СохранитьЗначениеРеквизита_НастройкиНоменклатуры(КонстантаИмя, КонстантаЗначение, Форма) Экспорт
	...
	Если КонстантаИмя <> "" Тогда
		...
		Если КонстантаИмя = "ИспользоватьСертификатыНоменклатуры" Тогда
			ВариантПроверкиСтатусов = НаборКонстант.ВариантПроверкиСтатусовСертификатовНоменклатурыРосаккредитации;
			
			Использование = КонстантаЗначение
							И ЗначениеЗаполнено(ВариантПроверкиСтатусов)
							И ВариантПроверкиСтатусов <> Перечисления.ВариантыПроверкиСтатусовСертификатовНоменклатурыРосаккредитации.НеПроверять;
...
Процедура ОпределитьНастройкиРегламентногоЗаданияОбновленияСтатусовСертификатовНоменклатурыРосаккредитации(Форма)
	...
	Если РегламентноеЗадание <> Неопределено Тогда
		Форма.ОбновлениеСтатусовСертификатовНоменклатурыРосаккредитацииИдентификатор	= РегламентноеЗадание.УникальныйИдентификатор;
		Форма.ОбновлениеСтатусовСертификатовНоменклатурыРосаккредитацииИспользование	= РегламентноеЗадание.Использование;
		Форма.ОбновлениеСтатусовСертификатовНоменклатурыРосаккредитацииРасписание		= РегламентноеЗадание.Расписание;
	КонецЕсли;
