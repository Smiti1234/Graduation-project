...
//  ПроверяемыеРеквизиты - Массив Из Строка - пути к реквизитам, для которых будет выполнена проверка заполнения,
//  МассивНепроверяемыхРеквизитов - Массив Из Строка - пути к реквизитам, для которых не будет выполнена проверка заполнения.
...
// 
// Параметры:
// Коэффициент - Число - Выходное значение коэффицинета упаковки.
