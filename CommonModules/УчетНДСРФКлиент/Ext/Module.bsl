...
Процедура ВвестиОтдельныеСчетаФактурыВыданныеЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт 
	...
	ПараметрыВыполнения = Новый Структура("ОписаниеКоманды", Новый Структура("МножественныйВыбор, ДополнительныеПараметры", Ложь, Новый Структура("Уникальность", Истина)));
	Для Каждого СчетФактураОснование Из ДополнительныеПараметры.СчетаФактурыОснования Цикл 
...
Процедура КорректировочныйСчетФактура(МассивСсылок, ПараметрыВыполнения) Экспорт
	...
	ИначеЕсли РеквизитыДляОбработки.Корректировочный Тогда
		...
		ЗначенияЗаполнения.Вставить("Исправление", РеквизитыДляОбработки.Исправление);
		ЗначенияЗаполнения.Вставить("СчетФактураОтбора", ПараметрКоманды);
