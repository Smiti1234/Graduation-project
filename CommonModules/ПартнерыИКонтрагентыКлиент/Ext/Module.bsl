	...
	Если ИсторияНаименований.Количество() > 0 Тогда
		...
		Для Счетчик = 0 По ИсторияНаименований.Количество() - 1 Цикл
			...
			Если Не ЭтоЮрЛицо Тогда
				Если СтрокаИсторииНаименований.Свойство("НаименованиеСокращенное") Тогда
					СтрокаИсторииНаименований.НаименованиеСокращенное = СтрШаблон(НСтр("ru = 'ИП %1'"), СтрокаНаименование.НаименованиеСокращенное);
				КонецЕсли;
				СтрокаИсторииНаименований.НаименованиеПолное = СтрШаблон(НСтр("ru = 'Индивидуальный предприниматель %1'"), СтрокаНаименование.НаименованиеСокращенное);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
