...
Процедура ДополнитьСвойстваПакетаИзРасширений(ТипXDTO, СвойстваИсточника, КомпонентыОбмена, Расширения)
	...
	// если есть, то обходить свойства в поисках новых (расширенных), но тогда этот алгоритм будет работать при выгрузке всех объектов
	// из-за чего будет потеря производительности.
