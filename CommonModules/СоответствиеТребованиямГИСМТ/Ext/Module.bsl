...
Функция РеквизитыДокумента(Документ) Экспорт
	...
	Если ЗначениеЗаполнено(РеквизитыДокумента.Контрагент) Тогда
		...
		РеквизитыДокумента.Вставить("КонтрагентИНН", ИННКПППоКонтрагенту.ИНН);
	КонецЕсли;
...
Процедура УдалитьИзРегистраДляОтслеживанияСоответствияТребованиямГИСМТ(МассивДокументов)
...
Процедура ДобавитьВРегистрДляОтслеживанияСоответствияТребованиямГИСМТ(Знач МассивДокументов)
	...
	Для Каждого Документ Из МассивДокументов Цикл
		...
		Если СтатусЭДО = "ЭДОНеНастроен" Или СуществующийРезультат <> Неопределено Тогда
			Возврат;
		КонецЕсли;
