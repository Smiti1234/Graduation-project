...
// 	 ОтменяемыйДокумент - ДокументСсылка.ОтчетПоКомиссииМеждуОрганизациями - Отменяемый отчет между организациями.
// 
Процедура ОбновитьСостояние(ОтчетыКомиссионеров, ОтменяемыйДокумент = Неопределено) Экспорт
	
	ОтменяемыйОтчет = Документы.ОтчетПоКомиссииМеждуОрганизациями.ПустаяСсылка();
	
	Если ТипЗнч(ОтменяемыйДокумент) = Тип("ДокументСсылка.ОтчетПоКомиссииМеждуОрганизациями") Тогда
	...
	|	И НЕ ДанныеОтчетовКомиссионеров.Регистратор = &ОтменяемыйОтчет
	...
	|	И НЕ СчетФактураКомиссионеру.ДокументОснование = &ОтменяемыйОтчет
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Удаление записей по непроведенным отчетам по комиссии между организациями в регистре ""Счета-фактуры комиссионерам к оформлению""'");
