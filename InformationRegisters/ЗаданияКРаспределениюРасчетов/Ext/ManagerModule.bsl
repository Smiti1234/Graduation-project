...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НаборЗаписей.Отбор.Валюта.Установить(Выборка.ВалютаРасчетов);
		...
		Иначе
			...
			Попытка
				...
				ЭлементБлокировки.УстановитьЗначение("Валюта", Выборка.ВалютаРасчетов);
				ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
				
				Блокировка.Заблокировать();
				
				ДанныеКОбработке.Очистить();
				ЗаполнитьЗначенияСвойств(ДанныеКОбработке.Добавить(),Выборка);
				ОперативныеВзаиморасчетыСервер.ВыполнитьОтложенноеРаспределение(Новый Структура("ДанныеКОбработке",ДанныеКОбработке));
