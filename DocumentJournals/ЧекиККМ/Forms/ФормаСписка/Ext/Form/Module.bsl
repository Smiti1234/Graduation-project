...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьФормуОплатыЧекаККМ")
		И ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Элементы, "ФормаОплаты") Тогда
...
Процедура УстановитьВидимостьЭлементовФормыЛокализация()
	...
	Элементы.ПолучитьСтатусыОперацийСБП.Видимость = РольДоступна("ОплатаВПлатежнойСистеме");
	Возврат;
	//-- Локализация
...
Процедура ПолучитьСтатусыОперацийСБПНаСервере()
	...
	//++ Локализация
	ИнтеграцияСПлатежнымиСистемами.СтатусыОперацийC2B();
	//-- Локализация
