...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПроверитьИУстановитьПараметВыводаДетализации(КомпоновщикНастроек, ДокументРезультат);
...
// Параметры:
//	ДокументРезультат - ТабличныйДокумент - основной табличный документ отчета.
Процедура ПроверитьИУстановитьПараметВыводаДетализации(КомпоновщикНастроек, ДокументРезультат)
