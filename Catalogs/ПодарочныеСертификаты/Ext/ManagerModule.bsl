...
Функция ПараметрыВзаиморасчеты(ДанныеЗаполнения = Неопределено) Экспорт
	...
	СтруктураПараметров.Организация                      = "Владелец.Организация";
	
	СтруктураПараметров.ОбъектРасчетов                   = "Объект.ОбъектРасчетов";
	
	// Валюта и сумма операции. Обязательно путь к реквизитам объекта.
	СтруктураПараметров.ВалютаДокумента                  = "Владелец.Валюта";
	СтруктураПараметров.СуммаДокумента                   = "Владелец.Номинал";
	...
	СтруктураПараметров.ГруппаФинансовогоУчета           = "Владелец.ГруппаФинансовогоУчета";
