...
Функция ЗаполнитьНаименованиеПоШаблонуСервер(ВариантыФормирования)
	...
	Если МассивВариантов.Найти("Рабочее") <> Неопределено Тогда
		...
		Если ДлинаРабочегоНаименования > МаксимальнаяДлинаРабочегоНаименования Тогда
			...
			МассивПредставлений = ПолучитьСклоненияСтрокиПоЧислу(НСтр("ru = 'символ'"), ДлинаРабочегоНаименования);
			...
			МассивПредставлений = ПолучитьСклоненияСтрокиПоЧислу(НСтр("ru = 'символ'"), МаксимальнаяДлинаРабочегоНаименования);
			Если МассивПредставлений.Количество() > 0 Тогда
...
Процедура ИменаСворачиваемыхГруппЛокализация(ИменаСворачиваемыхГрупп)
	...
	Если Элементы.Найти("СворачиваемаяГруппаГруппаВидыУпаковокИСМП") <> Неопределено Тогда
		ИменаСворачиваемыхГрупп.Добавить(Элементы["СворачиваемаяГруппаГруппаВидыУпаковокИСМП"].Имя);
	КонецЕсли;
