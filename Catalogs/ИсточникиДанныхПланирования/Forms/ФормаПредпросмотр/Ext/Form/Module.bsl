...
Процедура ОбновитьСтруктуруКроссТаблицы(ТаблицаПериоды, ПересчитыватьИтоговыеПоказатели = Истина)
	...
	Элементы.ТоварыПоПериодамЦена.Видимость = НЕ ЭтоОдинПериод;
	Элементы.ТоварыПоПериодамСумма.Видимость = НЕ ЭтоОдинПериод;
	...
	Планирование.ДобавитьПолеКроссТаблицыКоличество(ПараметрыВывода, Истина, Не ЭтоОдинПериод, Истина);
	Планирование.ДобавитьПолеКроссТаблицыЦена(ПараметрыВывода, Истина, Ложь);
	Планирование.ДобавитьПолеКроссТаблицыСумма(ПараметрыВывода, ЭтоОдинПериод);
