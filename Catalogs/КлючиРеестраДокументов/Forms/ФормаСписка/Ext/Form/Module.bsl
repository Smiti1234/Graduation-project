...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДанныеРегламентногоЗадания = ПолучитьДанныеРегламентногоЗадания();
...
Процедура ДекорацияРасписаниеПредставлениеНажатие(Элемент)
	...
	ОбработчикОповещения = Новый ОписаниеОповещения("ПослеРедактированияРасписания", ЭтотОбъект);
...
&НаКлиенте
Процедура ПослеРедактированияРасписания(Значение, ДополнительныеПараметры) Экспорт
...
Функция ПолучитьДанныеРегламентногоЗадания()
	...
	Результат = Новый Структура("УникальныйИдентификатор, Использование, Расписание");
	ЗаполнитьЗначенияСвойств(Результат, РегламентноеЗадание);
