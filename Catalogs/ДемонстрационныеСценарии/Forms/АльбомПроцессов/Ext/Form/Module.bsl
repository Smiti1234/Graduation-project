...
Процедура ТекстHTMLПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	ДемонстрационныеСценарииКлиент.ПриНажатииВПолеHTMLДокумента(Элемент, ДанныеСобытия, СтандартнаяОбработка)
...
Процедура ПреобразоватьДеревоДанных(ДеревоДанных)
	...
	Для Каждого СтрокаДерева Из ДеревоДанных.Строки Цикл
		...
		ПреобразоватьСтрокуДерева(СтрокаДерева);
...
&НаСервере
Процедура ПреобразоватьСтрокуДерева(СтрокаДерева)
	...
	Для Каждого ПодчиненнаяСтрока Из СтрокаДерева.Строки Цикл
		...
		ПреобразоватьСтрокуДерева(ПодчиненнаяСтрока);
