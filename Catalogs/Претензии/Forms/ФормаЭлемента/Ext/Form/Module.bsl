...
Процедура ДоступностьТекстДокументыНаОсновании()  
	...
	Если ЕстьПравоПросмотраДокументаПоОснованию Тогда
		ДоступностьТекстДокументыНаОсновании = ПараметрыРегистрации.КорректировкиЗадолженности.Количество() > 0;
	Иначе
		ДоступностьТекстДокументыНаОсновании = Истина;
	КонецЕсли;
