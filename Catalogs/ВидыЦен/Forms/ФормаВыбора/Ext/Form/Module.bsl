...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыводитьПроизвольныйВидЦен = Неопределено;
	Если Параметры.Свойство("ВыводитьПроизвольныйВидЦен", ВыводитьПроизвольныйВидЦен) И ВыводитьПроизвольныйВидЦен = Истина Тогда
