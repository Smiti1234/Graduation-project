...
Процедура ИнициализироватьНастройкиПоСпособуЗаданияЦены(ИзмененСпособЗаданияЦены = Ложь)
	...
	Иначе
		ХранилищеНастроекПеременная = Объект.Ссылка.ХранилищеНастроекПараметровСпособаЗаданияЦены;//ХранилищеЗначения
	...
	ИначеЕсли ТекущийОбъект.СпособЗаданияЦены = Перечисления.СпособыЗаданияЦен.НаценкаНаДругойВидЦен Тогда
		...
		Если ИспользоватьЦеновыеГруппы Тогда
			...
			Для Каждого СтрокаТЧ Из ТекущийОбъект.ЦеновыеГруппы Цикл
				...
				ИзвлечьБазовыеЦеныИзФормулы(ТекущийОбъект, "["+ИдентификаторБазовогоВидаЦен+"]");
