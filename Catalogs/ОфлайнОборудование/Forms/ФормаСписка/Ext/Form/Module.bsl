...
Процедура ОбновитьПользовательскийИнтерфейс()
	...
	Если ТекущееРабочееМесто = Справочники.РабочиеМеста.ПустаяСсылка()
		...
		РеквизитыТекущегоРабочегоМеста = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ТекущееРабочееМесто, "Код, ИмяКомпьютера");
	...
	Если ОтображатьДопЭлементы Тогда
		...
		Если РеквизитыТекущегоРабочегоМеста = Неопределено Тогда
			ТекущееРабочееМестоИмяКомпьютера = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТекущееРабочееМесто, "ИмяКомпьютера");
		Иначе
