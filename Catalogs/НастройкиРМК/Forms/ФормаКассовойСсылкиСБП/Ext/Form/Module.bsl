...
Процедура СформироватьQRКодНаСервере()
	...
	НастройкиТорговойТочки = ИнтеграцияСПлатежнымиСистемами.НастройкиТорговойТочки(НастройкаПодключения);
	...
	РезультатСоздания = ИнтеграцияСПлатежнымиСистемами.КассоваяСсылка(НастройкаПодключения);
...
Процедура ОтобразитьNFCСсылку()
	...
	Если ЗначениеЗаполнено(КассоваяСсылка) Тогда
		NFCСсылка = ИнтеграцияСПлатежнымиСистемамиКлиентСервер.ФункциональнаяСсылкаNFC(КассоваяСсылка);
	КонецЕсли;
